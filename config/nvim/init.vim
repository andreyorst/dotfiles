...
" Snippets
	...
	nnoremap ,gen<Tab> <Esc>0/;<CR>:set nohlsearch<CR>y^:silent!?private<CR>:-1read $HOME/.vim/snippets/obtain<CR>0Pa()<Esc>bbyw~hiobtain<Esc>/;<CR>P:noh<CR>>>j0>>/)<CR>bPnbb~hiestablish<Esc>nPnb~/ =<CR>P/;<CR>Pnb~?obtain<CR>y^j/(<CR>p^:set hlsearch<CR>:noh<CR>
