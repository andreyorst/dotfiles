...
#+BEGIN_SRC emacs-lisp
  (use-package multiple-cursors
    :bind
    (("M-s l" . mc/edit-lines)
     ("M-s e" . mc/edit-ends-of-lines)
     ("M-s a" . mc/edit-beginnings-of-lines)
     ("C-<mouse-1>" . mc/add-cursor-on-click)

     ;; Mark additional regions matching current region
     ("M-s p" . mc/mark-previous-like-this)
     ("M-s n" . mc/mark-next-like-this)
     ("M-s N" . mc/mark-more-like-this-extended)
     ("M-s A" . mc/mark-all-in-region)
     ("M-s r" . mc/mark-all-in-region-regexp)

     ;; Symbol and word specific mark-more
     ("M-s d" . mc/mark-next-word-like-this)
     ("M-s D" . mc/mark-previous-word-like-this)
