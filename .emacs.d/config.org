...
#+BEGIN_SRC emacs-lisp
  (use-package multiple-cursors
    ...
    (("C-S-c l" . mc/edit-lines)
     ...
     ("C-S-c N" . mc/mark-more-like-this-extended)
     ("C-S-c A" . mc/mark-all-in-region)
     ("C-S-c r" . mc/mark-all-in-region-regexp)

     ;; Symbol and word specific mark-more
     ("C-S-c d" . mc/mark-next-word-like-this)
     ("C-S-c D" . mc/mark-previous-word-like-this)
     ("C-S-c W" . mc/mark-all-words-like-this)))
#+END_SRC
