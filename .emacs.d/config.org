...
#+BEGIN_SRC emacs-lisp
  (use-package mc-extras
    :bind (("C-c m d" . mc/remove-duplicated-cursors))
    :init
    (add-hook 'post-command-hook 'mc/remove-duplicated-cursors))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package expand-region
    :bind
    (("C-c e e" . er/expand-region)
     ("C-c e p" . er/mark-paragraph)
     ("C-c e (" . er/mark-inside-pairs)
     ("C-c e )" . er/mark-outside-pairs)
