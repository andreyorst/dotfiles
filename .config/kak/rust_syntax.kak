...
add-highlighter shared/rust_syntax/code/field                regex ((?<!\.\.)(?<=\.))_?[a-zA-Z]\w*\b 0:meta
add-highlighter shared/rust_syntax/code/function_call        regex _?[a-zA-Z]\w*\s*(?=\() 0:function
...
add-highlighter shared/rust_syntax/code/return               regex \breturn\b 0:meta
